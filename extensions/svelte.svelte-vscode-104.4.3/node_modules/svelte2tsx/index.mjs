...
function parseHtmlx(htmlx, options) {
    ...
    const parsingCode = (options === null || options === void 0 ? void 0 : options.emitOnTemplateError) ? blankPossiblyErrorOperatorOrPropertyAccess(deconstructed)
        : deconstructed;
...
function classNameFromFilename(filename) {
    ...
    try {
        ...
        const withoutInvalidCharacters = withoutExtensions
            ...
            .join('');
        const withoutLeadingInvalidCharacters = withoutInvalidCharacters.substr(withoutInvalidCharacters.split('').findIndex((char) => /[A-Za-z_$]/.test(char)));
...
function svelte2tsx(svelte, options) {
    ...
    let { moduleScriptTag, scriptTag, slots, uses$$props, uses$$slots, uses$$restProps, events, componentDocumentation } = processSvelteTemplate(str, options);
