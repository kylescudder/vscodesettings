...
function parseHtmlx(htmlx, options) {
    ...
    const parsingCode = (options === null || options === void 0 ? void 0 : options.emitOnTemplateError) ? blankPossiblyErrorOperatorOrPropertyAccess(deconstructed)
        : deconstructed;
    const svelteHtmlxAst = compiler__default['default'].parse(parsingCode).html;
...
function convertHtmlxToJsx(str, ast, onWalk = null, onLeave = null) {
    ...
    str.prepend('<>');
    str.append('</>');
    compiler__default['default'].walk(ast, {
...
class ComponentEventsFromInterface {
    ...
    extractEvents(node) {
        const map = new Map();
        node.members.filter(ts__default['default'].isPropertySignature).forEach((member) => {
            var _a;
...
function processInstanceScriptContent(str, script, events) {
    ...
    const walk = (node, parent) => {
        ...
        if ((_a = ts.isTypeAssertionExpression) === null || _a === void 0 ? void 0 : _a.call(ts__namespace, node)) {
