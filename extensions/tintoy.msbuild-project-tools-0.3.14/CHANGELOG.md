...
* Bug-fix: Extension won't load, after changes for [tintoy/msbuild-project-tools-vscode#18](https://github.com/tintoy/msbuild-project-tools-vscode/issues/18), if no configuration was specified (restore configuration defaults).
...
* _Experimental:_ Add experimental feature flag (`empty-completion-lists`) to enable returning empty completion lists rather than null  
  Fixes [tintoy/msbuild-project-tools-vscode#17](https://github.com/tintoy/msbuild-project-tools-vscode/issues/17).  
...
* Bug-fix for [tintoy/msbuild-project-tools-vscode#11](https://github.com/tintoy/msbuild-project-tools-vscode/issues/11) (should not fail on non-standard file extension).
